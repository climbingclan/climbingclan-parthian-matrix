function readVolunteering(stmt) {
  makeReport(stmt, {
    ...
    query: `
      ...
      ORDER BY FIELD(pd.cc_volunteer, 
        "none", "Tuesday Facebook Promo","tuesdaypromo2", "Wednesday Facebook Promo","wednesdaypromo2", 
        "check in", "welcome liaison", "pairing","rounding up", "Pre-cake Preparation","announcements", 
        "after cake tidy", "event director", "Event Reporter","Wednesday Evening Trainer", 
        "floorwalker","Friday Facebook Promo","Summit Up Promo") ASC, 
        pd.cc_volunteer ASC, 
    ...
    formatting: [
      ...
      { type: 'columnWidth', column: "First Name", width: 80 },
      { type: 'columnWidth', column: "Last Name", width: 90 },
      { type: 'columnWidth', column: "Selected Roles", width: 80 },
